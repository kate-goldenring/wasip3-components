...
const IMAGES: &[&[u8]] = &[
    include_bytes!("../images/0.jpg"),
    include_bytes!("../images/1.jpg"),
    include_bytes!("../images/2.jpg"),
    include_bytes!("../images/3.jpg"),
    include_bytes!("../images/4.jpg"),
    include_bytes!("../images/5.jpg"),
    include_bytes!("../images/6.jpg"),
    include_bytes!("../images/7.jpg"),
    include_bytes!("../images/fake.jpg"),
];
...
impl Handler for Component {
    async fn handle(request: Request) -> Result<Response, ErrorCode> {
        ...
        Ok(Response::new(headers, Body::new(pipe_rx, None)))
    }
}
